...
export default function TaskTable({
  ...
  if (!project || !app)
    return <div className="card">No project or app found</div>;
    ...
    <div className="space-y-4">
      {current && (
        <SprintSection
          ...
          columns={app.columns}
          app={app}
          onEditTask={(taskId, partial) =>
            onEditTask?.(current.id, taskId, partial)
          }
      ...
      {backlog.map((g) => (
        <SprintSection
          ...
          app={app}
          onEditTask={(taskId, partial) =>
            onEditTask?.(g.sprintId, taskId, partial)
          }
